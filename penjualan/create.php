...
<tbody>
        ...
        m_satuan.satuan, m_kategori.kategori from tr_penjualan_detail 
			...
			left join m_kategori ON m_barang.id_kategori=m_kategori.id where session_id='$sid'");
            ...
            <div class="card-body">
                <form method="post" action="proses.php?act=input" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" name="no_faktur" class="form-control" id="no_faktur" placeholder="No Faktur" required>
                    </div>
					<div class="form-group">
                        <label for="kd_barang">Tanggal Faktur :</label>
                        <input type="date" name="tgl_faktur" class="form-control" id="tgl_faktur" placeholder="Tgl Faktur" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="kd_barang">Nama Konsumen :</label>
                        <input type="text" name="nm_konsumen" class="form-control" id="nm_konsumen" placeholder="Nama Konsumen" required>
                    </div>
