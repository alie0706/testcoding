...
<tbody>
		...
		while($d = mysqli_fetch_array($data)){
			...
			<tr>
				...
				<td>
                        <a href="updatePenjualan.php?id=<?php echo $d['id']; ?>" class="btn btn-warning text-white mb-2">Edit</a>
                        <a href="proses.php?act=deletedetail&id=<?php echo $d['id']; ?>" class="btn btn-danger mb-2">Hapus</a>
                    </td>
                </tr>
                <?php
            }
        ...
        <div class="card-header text-center font-weight-bold">
            ...
            ?>
            <div class="card-body">
                <form method="post" action="proses.php?act=updateDetail" enctype="multipart/form-data">
                    
                <input type="hidden" name="id" value="<?php echo $d['id'] ?>">
                    <div class="form-group">
                        <label for="kd_barang">No Faktur :</label>
                        <input type="text" name="no_faktur" value="<?php echo $d['no_faktur'];?>" class="form-control" id="no_faktur" placeholder="No Faktur" required>
                    </div>
					<div class="form-group">
                        <label for="kd_barang">Tanggal Faktur :</label>
                        <input type="date" name="tgl_faktur" value="<?php echo $d['tgl_faktur'];?>" class="form-control" id="tgl_faktur" placeholder="Tgl Faktur" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="kd_barang">Nama Konsumen :</label>
                        <input type="text" name="nm_konsumen" value="<?php echo $d['nm_konsumen'];?>" class="form-control" id="nm_konsumen" placeholder="Nama Konsumen" required>
                    </div>
